...
|          | _Auditors are listenning for the datagram. When they receive a datagram, they add the transmitting musician to the active musician list if it doesn't already exists. This list is checked avery 5 seconds to remove musicians that are not active anymore._                                                                                                                                           |
